						...
						<form action="/admin/users/add" method="POST">
							...
							<fieldset class="form-horizontal">
									...
									<div class="col-sm-10">
										<select name="company_subscribed" class="form-control" id="company_subscribed">
											@foreach ($companies as $company)
												<option {{old('company_subscribed') == $company->id ? 'selected' : ''}} value="{{$company->id}}">{{$company->name}}</option>
											@endforeach
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="checkbox"><label><input type="checkbox" name="can_access_watchlists" value="1"{{ old('can_access_watchlists') ? ' checked' : '' }}> Watchlists</label></div>
									</div>
								</div>
								<div class="row">
									<div class="form-group">
